...
RSpec.describe RegisteredApplicationsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested registered_application as @registered_application" do
      registered_application = RegisteredApplication.create! valid_attributes
      get :show, {:id => registered_application.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested registered_application as @registered_application" do
      registered_application = RegisteredApplication.create! valid_attributes
      get :edit, {:id => registered_application.to_param}, valid_session
      expect(assigns(:registered_application)).to eq(registered_application)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new RegisteredApplication" do
        expect {
          post :create, {:registered_application => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved registered_application as @registered_application" do
        post :create, {:registered_application => invalid_attributes}, valid_session
        expect(assigns(:registered_application)).to be_a_new(RegisteredApplication)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested registered_application" do
        registered_application = RegisteredApplication.create! valid_attributes
        put :update, {:id => registered_application.to_param, :registered_application => new_attributes}, valid_session
      ...
      it "assigns the requested registered_application as @registered_application" do
        registered_application = RegisteredApplication.create! valid_attributes
        put :update, {:id => registered_application.to_param, :registered_application => valid_attributes}, valid_session
        expect(assigns(:registered_application)).to eq(registered_application)
      end
    ...
    context "with invalid params" do
      it "assigns the registered_application as @registered_application" do
        registered_application = RegisteredApplication.create! valid_attributes
        put :update, {:id => registered_application.to_param, :registered_application => invalid_attributes}, valid_session
        expect(assigns(:registered_application)).to eq(registered_application)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested registered_application" do
      registered_application = RegisteredApplication.create! valid_attributes
      expect {
        delete :destroy, {:id => registered_application.to_param}, valid_session
      }.to change(RegisteredApplication, :count).by(-1)
    end
